...
class Peer(object):
    ...
    @property
    def x(self):
        """ Calculate x position based on range and bearing """
        return self.range * math.cos(self.bearing * math.pi / 180)

    @property
    def y(self):
        """ Calculate y position based on range and bearing """
        return self.range * math.sin(self.bearing * math.pi / 180)
